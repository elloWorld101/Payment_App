    ...
    return(
        ...
        <div class=" bg-blue-400 flex flex-col items-center justify-center"> 
            ...
            ">
                ...
                <h2 class="lg:text-2xl font-semibold lg:p-0 text-md">Payments App</h2>
                    ...
                    class="font-medium pl-3 lg:p-0 text-md">
                        ...
                        class="lg:px-3 lg:ml-2 lg:text-lg lg:rounded-full lg:bg-teal-800 lg:text-white lg:font-semibold lg:p-1 group relative
                            ...
                            {user.box}
                            <div class="absolute text-base top-full text-black right-3 bg-white rounded-md  shadow-md scale-y-0 group-focus:scale-y-100 origin-top duration-200">
                                <a class="active hover:bg-blue-300 m-2" onClick={update}>Update</a><br />
                                <a class="hover:bg-red-300 " onClick={logout}>Logout</a>
                            </div>
                            </button></p>
                    </div>}
